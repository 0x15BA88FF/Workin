			...
			<nav className="w-screen fixed top-0 px-6 p-4">
				<div className="flex items-center justify-between">
					<div className="flex gap-4 items-center">
						<button className="gap-2 flex flex-col items-center md:hidden">
						...
						<Link href="#" className="ml-2 hidden font-semibold md:block">Find Job</Link>
						<Link href="#" className="hidden font-semibold md:block">My Jobs</Link>
					</div>
					<div className="flex items-center gap-4">
						<Link href="#" className="hidden font-semibold md:block">Log in</Link>
